...
abstract class VideosAPI {
  ...
  static Future<VideosResponse> getVideosByCategory(
      ...
      videosResponseFromJson((await http.get(
              'https://video.americonictv.com/plugin/API/get.json.php?APIName=video&catName=$categoryName&rowCount=60&current=$page' +
  ...
  static Future<VideosResponse> getChannelVideos(String channel, int page,
      ...
      videosResponseFromJson((await http.get(
              'https://video.americonictv.com/plugin/API/get.json.php?APIName=video&channelName=$channel&current=$page&rowCount=' +
                  (infinite ? '1000' : '60')))
          .body);
